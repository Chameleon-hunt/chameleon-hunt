            ...
            >
              ...
              <div className="flex items-start gap-3 ml-2">
                <div className="flex-shrink-0">
                  <FigureSVG found={isFound} size={48} />
                </div>
    ...
    <div className="flex-grow p-5 md:p-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pb-6 max-w-3xl">
        {steps.map(({ n, color, title, body }) => (
          ...
          >
            <div
              className="w-11 h-11 rounded-full flex items-center justify-center font-black text-base mb-3"
              style={{
                background: `${color}20`,
                color,
                fontFamily: "'Righteous', sans-serif",
      ...
      <div
        className="rounded-3xl p-5 max-w-3xl mb-12"
        style={{
...
export function Game({
  ...
  const [foundIds, setFoundIds] = useState<number[]>(() => {
    const local: number[] = (() => {
      try {
        return JSON.parse(localStorage.getItem("chameleon_hunt_found") ?? "[]");
      } catch {
        return [];
      }
    })();
  ...
  const handleNavigate = useCallback(
    async (fig: Figure): Promise<NavInfo | null> => {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(180deg, rgba(6,6,20,0.98) 0%, rgba(8,8,26,0.95) 100%)",
      ...
      >
                ...
                style={{
                  ...
                  background:
                    activePage === page
                      ...
                      : "transparent",
                  color:
                    activePage === page ? "#FF6B00" : "rgba(255,255,255,0.45)",
                  border:
                    activePage === page
                      ? "1px solid rgba(255,107,0,0.38)"
          ...
          <div className="flex items-center gap-2">
            ...
            >
              ...
              <span className="text-white font-bold text-sm">
                {foundIds.length}/{FIGURES.length}
              </span>
            </div>
            <UserMenu />
          </div>
        ...
        <div className="relative z-10 px-4 pb-3 flex items-center gap-3">
          ...
          <span className="text-white/30 text-xs">
            {foundIds.length}/{FIGURES.length} {t.foundLabel}
          </span>
        </div>
      </div>
      ...
      <div className="flex-grow flex flex-col">
        {activePage === "map" && (
          <>
            ...
            <div
              className="flex-grow p-5 md:p-8"
              style={{ background: "rgba(6,6,18,0.98)" }}
            >
              <h2
                className="text-white mb-5 flex items-center gap-3"
                style={{
                  fontFamily: "'Righteous', sans-serif",
                  fontSize: "1.5rem",
                  letterSpacing: "0.05em",
